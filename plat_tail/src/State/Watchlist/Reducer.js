...
import  { GET_USER_WATCHLIST_REQUEST, ADD_COIN_TO_WATCHLIST_REQUEST, ADD_COIN_TO_WATCHLIST_SUCCESS, GET_USER_WATCHLIST_SUCCESS, ADD_COIN_TO_WATCHLIST_FAILURE, GET_USER_WATCHLIST_FAILURE } from "./ActionType";
  ...
  switch (action.type){
    ...
    case GET_USER_WATCHLIST_SUCCESS:
      ...
      case ADD_COIN_TO_WATCHLIST_SUCCESS:
        ...
        (state.items.filter((item) => item.id !== action.payload.id)) : [action.payload , ...state.items]
